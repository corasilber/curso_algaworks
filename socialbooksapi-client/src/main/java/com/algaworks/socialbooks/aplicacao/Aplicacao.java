...
public class Aplicacao {
	...
	public static void main(String[]args) throws ParseException {
		...
		for(Livro livro : listaLivros){
			System.out.print("Livro:" + livro.getNome());
		}
		...
		livro.setPublicacao(publicacao.parse("10/01/2016"));
	
		livro.setResumo("este livro aborda tecnicas de desenviolvimento de APIs");
